...
<!--http://localhost/kadai1/20.09.17/regist.php-->
                        ...
                        <li>
                            <p><label>アカウント権限</label>
                                ...
                                <select name="authority">
                                    <?php
                                        for($a=0;$a<2;$a++){
                                            if(isset($_POST['autority'])){
                                                echo '<option selected>'.$kengen[$a].'</option>';
                                            }else{
                                            echo '<option>'.$kengen[$a].'</option>';
                                        }}
                                    ?>    
                                </select>
                            </p>
